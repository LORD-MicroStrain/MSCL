...
namespace mscl
{
    ...
    public:
        ...
        //
        //Returns:
        // bool - indicates whether the function selector is supported by the specified command.
    ...
    protected:
        ...
        virtual MipTypes::Command commandType() const
        {
            return m_commandId;
        }
    ...
    private:
        ...
        static void populateGenericResponseData(MipTypes::Command id, DataBuffer& buffer, const MipFieldFormat& format, MipFieldValues& outData,
            uint8 vectorNestedLevel = 0, uint8 vectorSequenceCount = 0);
    };
} // namespace mscl
