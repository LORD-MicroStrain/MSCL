...
namespace mscl
{
    ...
    public:
        ...
        std::string commandName() const override { return "MagnetometerHardIronOffset"; }
    ...
    private:
        ...
        MipTypes::Command commandType() const override { return MipTypes::CMD_MAG_HARD_IRON_OFFSET; }

        //Function: fieldDataByte
        //
        //Returns:
        //    uint8 - the byte ID for field data in the reply.
        uint8 fieldDataByte() const override { return 0x9C; }
