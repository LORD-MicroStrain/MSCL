...
namespace mscl
{
    LdcMathPacket_aspp3::LdcMathPacket_aspp3(const WirelessPacket& packet)
    {
    ...
    void LdcMathPacket_aspp3::parseSweeps()
    {
    ...
    bool LdcMathPacket_aspp3::integrityCheck(const WirelessPacket& packet)
    {
        ...
        const uint8 numAlgorithms = payload.read_uint8(11);
        uint8 readPos = 12;
    ...
    UniqueWirelessPacketId LdcMathPacket_aspp3::getUniqueId(const WirelessPacket& packet)
    {
