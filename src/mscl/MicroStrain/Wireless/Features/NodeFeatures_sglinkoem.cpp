...
namespace mscl
{
    ...
    uint32 NodeFeatures_sglinkoem::minSensorDelay() const
    {
    ...
    uint32 NodeFeatures_sglinkoem::maxSensorDelay() const
    {
        if (!supportsSensorDelayConfig())
        {
            throw Error_NotSupported("Sensor Delay is not supported by this Node.");
    ...
    uint32 NodeFeatures_sglinkoem::defaultSensorDelay() const
    {
        if (!supportsSensorDelayConfig())
        {
            throw Error_NotSupported("Sensor Delay is not supported by this Node.");
