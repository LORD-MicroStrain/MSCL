...
public class WirelessNode : global::System.IDisposable {
  ...
  public ChannelMask getDerivedChannelMask(WirelessTypes.DerivedChannelType derivedChannelType) {
    ChannelMask ret = new ChannelMask(msclPINVOKE.WirelessNode_getDerivedChannelMask(swigCPtr, (int)derivedChannelType), true);
    if (msclPINVOKE.SWIGPendingException.Pending) throw msclPINVOKE.SWIGPendingException.Retrieve();
    return ret;
  }
