...
public class DefaultModes : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<WirelessTypes.DefaultMode>
 {
  ...
  public DefaultModes(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public DefaultModes(global::System.Collections.Generic.IEnumerable<WirelessTypes.DefaultMode> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (WirelessTypes.DefaultMode element in c) {
      this.Add(element);
  ...
  public WirelessTypes.DefaultMode[] ToArray() {
    WirelessTypes.DefaultMode[] array = new WirelessTypes.DefaultMode[this.Count];
    this.CopyTo(array);
    return array;
  }
