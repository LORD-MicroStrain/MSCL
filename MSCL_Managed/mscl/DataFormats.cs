...
public class DataFormats : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<WirelessTypes.DataFormat>
 {
  ...
  public DataFormats(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public DataFormats(global::System.Collections.Generic.IEnumerable<WirelessTypes.DataFormat> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (WirelessTypes.DataFormat element in c) {
      this.Add(element);
  ...
  public WirelessTypes.DataFormat[] ToArray() {
    WirelessTypes.DataFormat[] array = new WirelessTypes.DataFormat[this.Count];
    this.CopyTo(array);
    return array;
  }
