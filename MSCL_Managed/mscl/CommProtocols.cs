...
public class CommProtocols : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<WirelessTypes.CommProtocol>
 {
  ...
  public CommProtocols(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public CommProtocols(global::System.Collections.Generic.IEnumerable<WirelessTypes.CommProtocol> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (WirelessTypes.CommProtocol element in c) {
      this.Add(element);
  ...
  public WirelessTypes.CommProtocol[] ToArray() {
    WirelessTypes.CommProtocol[] array = new WirelessTypes.CommProtocol[this.Count];
    this.CopyTo(array);
    return array;
  }
