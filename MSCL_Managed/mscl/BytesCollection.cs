...
public class BytesCollection : global::System.IDisposable, global::System.Collections.IEnumerable, global::System.Collections.Generic.IEnumerable<Bytes>
 {
  ...
  public BytesCollection(global::System.Collections.IEnumerable c) : this() {
    if (c == null)
  ...
  public BytesCollection(global::System.Collections.Generic.IEnumerable<Bytes> c) : this() {
    if (c == null)
      throw new global::System.ArgumentNullException("c");
    foreach (Bytes element in c) {
      this.Add(element);
  ...
  public Bytes[] ToArray() {
    Bytes[] array = new Bytes[this.Count];
    this.CopyTo(array);
    return array;
  }
