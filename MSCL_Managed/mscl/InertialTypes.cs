...
public class InertialTypes : global::System.IDisposable {
  ...
  public static string channelName(InertialTypes.ChannelField field, InertialTypes.ChannelQualifier qualifier) {
    string ret = msclPINVOKE.InertialTypes_channelName((int)field, (int)qualifier);
  ...
  public static readonly ushort GX5_45_MODEL_NUMBER = msclPINVOKE.InertialTypes_GX5_45_MODEL_NUMBER_get();
  public enum InertialCategory {
