...
- [**Python**](python/README.md) - Examples using the Python MSCL library.
...
The recommended way to build and run the examples is using **CMake**. Each
example is configured to work either as part of the main MSCL build or as a
standalone project.
