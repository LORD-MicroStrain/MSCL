In most cases, you don't need to build MSCL from source. Simply [download the latest pre-built binaries (1.32.0)](https://github.com/LORD-MicroStrain/MSCL/releases/download/v1.32.0/MSCL_1.32.0.zip). 
