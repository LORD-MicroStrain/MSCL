...
BOOST_AUTO_TEST_CASE(InertialFieldParser_FilterStatus_parse)
{
    ...
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_FILTER_STATUS, bytes.data());
    ...
    //Filter State
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_FILTER_STATUS);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_FILTER_STATE);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_uint16);
    BOOST_CHECK_EQUAL(data.at(0).valid(), true);
    BOOST_CHECK_EQUAL(data.at(0).as_uint16(), InertialDataEnums::FILTERSTATE_RUNNING_SLN_ERROR);
    BOOST_CHECK_EQUAL(data.at(0).channelName(), "estFilterState");

    //Dynamics Mode
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_FILTER_STATUS);
    BOOST_CHECK_EQUAL(data.at(1).qualifier(), InertialTypes::CH_DYNAMICS_MODE);
    BOOST_CHECK_EQUAL(data.at(1).storedAs(), valueType_uint16);
    BOOST_CHECK_EQUAL(data.at(1).valid(), true);
    BOOST_CHECK_EQUAL(data.at(1).as_uint16(), InertialDataEnums::DYNAMICSMODE_AUTOMOTIVE);
    BOOST_CHECK_EQUAL(data.at(1).channelName(), "estFilterDynamicsMode");

    //flags
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_FILTER_STATUS);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_GPSTimestamp_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_GPS_TIMESTAMP, bytes.data());
    ...
    //Time of Week
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_GPS_TIMESTAMP);
    ...
    //Week Number
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_GPS_TIMESTAMP);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedLLHPosition_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_LLH_POS, bytes.data());
    ...
    //Latitude
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_LLH_POS);
    ...
    //Longitude
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_LLH_POS);
    ...
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_LLH_POS);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedNEDVelocity_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_NED_VELOCITY, bytes.data());
    ...
    //north
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_NED_VELOCITY);
    ...
    //east
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_NED_VELOCITY);
    ...
    //down
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_NED_VELOCITY);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedQuaternion_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ORIENT_QUATERNION, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ORIENT_QUATERNION);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedOrientMatrix_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ORIENT_MATRIX, bytes.data());
    ...
    //verify the field was parsed correctly
    BOOST_CHECK_EQUAL(data.size(), 1);
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ORIENT_MATRIX);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedEulerAngles_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ORIENT_EULER, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ORIENT_EULER);
    ...
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ORIENT_EULER);
    ...
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ORIENT_EULER);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedGyroBias_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_GYRO_BIAS, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_GYRO_BIAS);
    ...
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_GYRO_BIAS);
    ...
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_GYRO_BIAS);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedAccelBias_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ACCEL_BIAS, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ACCEL_BIAS);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_X);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(0).valid(), true);
    BOOST_CHECK_CLOSE(data.at(0).as_float(), 2.345, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ACCEL_BIAS);
    BOOST_CHECK_EQUAL(data.at(1).qualifier(), InertialTypes::CH_Y);
    BOOST_CHECK_EQUAL(data.at(1).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(1).valid(), true);
    BOOST_CHECK_CLOSE(data.at(1).as_float(), 0.0, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ACCEL_BIAS);
    BOOST_CHECK_EQUAL(data.at(2).qualifier(), InertialTypes::CH_Z);
    BOOST_CHECK_EQUAL(data.at(2).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(2).valid(), true);
    BOOST_CHECK_CLOSE(data.at(2).as_float(), 0.0, 0.0001);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedLLHUncertainty_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_LLH_UNCERT, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_LLH_UNCERT);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_NORTH);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(0).valid(), false);
    ...
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_LLH_UNCERT);
    BOOST_CHECK_EQUAL(data.at(1).qualifier(), InertialTypes::CH_EAST);
    BOOST_CHECK_EQUAL(data.at(1).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(1).valid(), false);
    ...
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_LLH_UNCERT);
    BOOST_CHECK_EQUAL(data.at(2).qualifier(), InertialTypes::CH_DOWN);
    BOOST_CHECK_EQUAL(data.at(2).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(2).valid(), false);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedNEDUncertainty_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_NED_UNCERT, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_NED_UNCERT);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_NORTH);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(0).valid(), true);
    BOOST_CHECK_CLOSE(data.at(0).as_float(), 1.234, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_NED_UNCERT);
    BOOST_CHECK_EQUAL(data.at(1).qualifier(), InertialTypes::CH_EAST);
    BOOST_CHECK_EQUAL(data.at(1).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(1).valid(), true);
    BOOST_CHECK_CLOSE(data.at(1).as_float(), 4.567, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_NED_UNCERT);
    BOOST_CHECK_EQUAL(data.at(2).qualifier(), InertialTypes::CH_DOWN);
    BOOST_CHECK_EQUAL(data.at(2).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(2).valid(), true);
    BOOST_CHECK_CLOSE(data.at(2).as_float(), 9.988, 0.0001);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedAttEulerUncertainty_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ATT_UNCERT_EULER, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ATT_UNCERT_EULER);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_ROLL);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(0).valid(), true);
    BOOST_CHECK_CLOSE(data.at(0).as_float(), 1.234, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ATT_UNCERT_EULER);
    BOOST_CHECK_EQUAL(data.at(1).qualifier(), InertialTypes::CH_PITCH);
    BOOST_CHECK_EQUAL(data.at(1).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(1).valid(), true);
    BOOST_CHECK_CLOSE(data.at(1).as_float(), 4.567, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ATT_UNCERT_EULER);
    BOOST_CHECK_EQUAL(data.at(2).qualifier(), InertialTypes::CH_YAW);
    BOOST_CHECK_EQUAL(data.at(2).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(2).valid(), true);
    BOOST_CHECK_CLOSE(data.at(2).as_float(), 9.988, 0.0001);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedGyroBiasUncertainty_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_GYRO_BIAS_UNCERT, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_GYRO_BIAS_UNCERT);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_X);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(0).valid(), false);
    BOOST_CHECK_CLOSE(data.at(0).as_float(), 1.234, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_GYRO_BIAS_UNCERT);
    BOOST_CHECK_EQUAL(data.at(1).qualifier(), InertialTypes::CH_Y);
    BOOST_CHECK_EQUAL(data.at(1).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(1).valid(), false);
    BOOST_CHECK_CLOSE(data.at(1).as_float(), 4.567, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_GYRO_BIAS_UNCERT);
    BOOST_CHECK_EQUAL(data.at(2).qualifier(), InertialTypes::CH_Z);
    BOOST_CHECK_EQUAL(data.at(2).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(2).valid(), false);
    BOOST_CHECK_CLOSE(data.at(2).as_float(), 9.988, 0.0001);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedAccelBiasUncertainty_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ACCEL_BIAS_UNCERT, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ACCEL_BIAS_UNCERT);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_X);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(0).valid(), false);
    BOOST_CHECK_CLOSE(data.at(0).as_float(), 1.234, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ACCEL_BIAS_UNCERT);
    BOOST_CHECK_EQUAL(data.at(1).qualifier(), InertialTypes::CH_Y);
    BOOST_CHECK_EQUAL(data.at(1).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(1).valid(), false);
    BOOST_CHECK_CLOSE(data.at(1).as_float(), 4.567, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ACCEL_BIAS_UNCERT);
    BOOST_CHECK_EQUAL(data.at(2).qualifier(), InertialTypes::CH_Z);
    BOOST_CHECK_EQUAL(data.at(2).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(2).valid(), false);
    BOOST_CHECK_CLOSE(data.at(2).as_float(), 9.988, 0.0001);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedLinearAccel_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_LINEAR_ACCEL, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_LINEAR_ACCEL);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_X);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(0).valid(), false);
    BOOST_CHECK_CLOSE(data.at(0).as_float(), 1.234, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_LINEAR_ACCEL);
    BOOST_CHECK_EQUAL(data.at(1).qualifier(), InertialTypes::CH_Y);
    BOOST_CHECK_EQUAL(data.at(1).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(1).valid(), false);
    BOOST_CHECK_CLOSE(data.at(1).as_float(), 4.567, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_LINEAR_ACCEL);
    BOOST_CHECK_EQUAL(data.at(2).qualifier(), InertialTypes::CH_Z);
    BOOST_CHECK_EQUAL(data.at(2).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(2).valid(), false);
    BOOST_CHECK_CLOSE(data.at(2).as_float(), 9.988, 0.0001);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedAngularRate_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ANGULAR_RATE, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ANGULAR_RATE);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_X);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(0).valid(), false);
    BOOST_CHECK_CLOSE(data.at(0).as_float(), 1.234, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ANGULAR_RATE);
    BOOST_CHECK_EQUAL(data.at(1).qualifier(), InertialTypes::CH_Y);
    BOOST_CHECK_EQUAL(data.at(1).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(1).valid(), false);
    BOOST_CHECK_CLOSE(data.at(1).as_float(), 4.567, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ANGULAR_RATE);
    BOOST_CHECK_EQUAL(data.at(2).qualifier(), InertialTypes::CH_Z);
    BOOST_CHECK_EQUAL(data.at(2).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(2).valid(), false);
    BOOST_CHECK_CLOSE(data.at(2).as_float(), 9.988, 0.0001);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_WGS84LocalGravMagnitude_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_WGS84_LOC_GRAV_MAGNITUDE, bytes.data());
    ...
    //verify the field was parsed correctly
    BOOST_CHECK_EQUAL(data.size(), 1);
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_WGS84_LOC_GRAV_MAGNITUDE);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_MAGNITUDE);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(0).valid(), true);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedAttQuaternUncertainty_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ATT_UNCERT_QUAT, bytes.data());
    ...
    //verify the field was parsed correctly
    BOOST_CHECK_EQUAL(data.size(), 1);
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_ATT_UNCERT_QUAT);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_QUATERNION);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_Vector);
    BOOST_CHECK_EQUAL(data.at(0).valid(), true);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedGravityVector_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_GRAVITY_VECTOR, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_GRAVITY_VECTOR);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_X);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(0).valid(), false);
    BOOST_CHECK_CLOSE(data.at(0).as_float(), 1.234, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_GRAVITY_VECTOR);
    BOOST_CHECK_EQUAL(data.at(1).qualifier(), InertialTypes::CH_Y);
    BOOST_CHECK_EQUAL(data.at(1).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(1).valid(), false);
    BOOST_CHECK_CLOSE(data.at(1).as_float(), 4.567, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_GRAVITY_VECTOR);
    BOOST_CHECK_EQUAL(data.at(2).qualifier(), InertialTypes::CH_Z);
    BOOST_CHECK_EQUAL(data.at(2).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(2).valid(), false);
    BOOST_CHECK_CLOSE(data.at(2).as_float(), 9.988, 0.0001);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_HeadingUpdateSource_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_HEADING_UPDATE_SOURCE, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_HEADING_UPDATE_SOURCE);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_HEADING);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(0).valid(), false);
    BOOST_CHECK_CLOSE(data.at(0).as_float(), 1.234, 0.0001);
    BOOST_CHECK_NO_THROW(data.at(0).channelName());

    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_HEADING_UPDATE_SOURCE);
    BOOST_CHECK_EQUAL(data.at(1).qualifier(), InertialTypes::CH_HEADING_UNCERTAINTY);
    BOOST_CHECK_EQUAL(data.at(1).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(1).valid(), false);
    BOOST_CHECK_CLOSE(data.at(1).as_float(), 4.567, 0.0001);
    BOOST_CHECK_NO_THROW(data.at(1).channelName());

    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_HEADING_UPDATE_SOURCE);
    BOOST_CHECK_EQUAL(data.at(2).qualifier(), InertialTypes::CH_SOURCE);
    BOOST_CHECK_EQUAL(data.at(2).storedAs(), valueType_uint16);
    BOOST_CHECK_EQUAL(data.at(2).valid(), false);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_MagneticModelSln_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_MAGNETIC_MODEL_SLN, bytes.data());
    ...
    //intensity vector
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_MAGNETIC_MODEL_SLN);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_NORTH);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(0).valid(), true);
    BOOST_CHECK_CLOSE(data.at(0).as_float(), 1.234, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_MAGNETIC_MODEL_SLN);
    BOOST_CHECK_EQUAL(data.at(1).qualifier(), InertialTypes::CH_EAST);
    BOOST_CHECK_EQUAL(data.at(1).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(1).valid(), true);
    ...
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_MAGNETIC_MODEL_SLN);
    BOOST_CHECK_EQUAL(data.at(2).qualifier(), InertialTypes::CH_DOWN);
    BOOST_CHECK_EQUAL(data.at(2).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(2).valid(), true);
    ...
    //inclination
    BOOST_CHECK_EQUAL(data.at(3).field(), InertialTypes::CH_FIELD_ESTFILTER_MAGNETIC_MODEL_SLN);
    BOOST_CHECK_EQUAL(data.at(3).qualifier(), InertialTypes::CH_INCLINATION);
    ...
    //declination
    BOOST_CHECK_EQUAL(data.at(4).field(), InertialTypes::CH_FIELD_ESTFILTER_MAGNETIC_MODEL_SLN);
    BOOST_CHECK_EQUAL(data.at(4).qualifier(), InertialTypes::CH_DECLINATION);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedGyroScaleFactor_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_GYRO_SCALE_FACTOR, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_GYRO_SCALE_FACTOR);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_X);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(0).valid(), false);
    ...
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_GYRO_SCALE_FACTOR);
    BOOST_CHECK_EQUAL(data.at(1).qualifier(), InertialTypes::CH_Y);
    BOOST_CHECK_EQUAL(data.at(1).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(1).valid(), false);
    ...
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_ESTIMATED_GYRO_SCALE_FACTOR);
    BOOST_CHECK_EQUAL(data.at(2).qualifier(), InertialTypes::CH_Z);
    BOOST_CHECK_EQUAL(data.at(2).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(2).valid(), false);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedAccelScaleFactor_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_ACCEL_SCALE_FACTOR, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_ACCEL_SCALE_FACTOR);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_X);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(0).valid(), true);
    BOOST_CHECK_CLOSE(data.at(0).as_float(), 1.978, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_ACCEL_SCALE_FACTOR);
    BOOST_CHECK_EQUAL(data.at(1).qualifier(), InertialTypes::CH_Y);
    BOOST_CHECK_EQUAL(data.at(1).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(1).valid(), true);
    BOOST_CHECK_CLOSE(data.at(1).as_float(), 4.789, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_ACCEL_SCALE_FACTOR);
    BOOST_CHECK_EQUAL(data.at(2).qualifier(), InertialTypes::CH_Z);
    BOOST_CHECK_EQUAL(data.at(2).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(2).valid(), true);
    BOOST_CHECK_CLOSE(data.at(2).as_float(), 16.001, 0.0001);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedGyroScaleFactorUncert_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_GYRO_SCALE_FACTOR_UNCERT, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_GYRO_SCALE_FACTOR_UNCERT);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_X);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(0).valid(), false);
    BOOST_CHECK_CLOSE(data.at(0).as_float(), 1.978, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_GYRO_SCALE_FACTOR_UNCERT);
    BOOST_CHECK_EQUAL(data.at(1).qualifier(), InertialTypes::CH_Y);
    BOOST_CHECK_EQUAL(data.at(1).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(1).valid(), false);
    BOOST_CHECK_CLOSE(data.at(1).as_float(), 4.789, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_GYRO_SCALE_FACTOR_UNCERT);
    BOOST_CHECK_EQUAL(data.at(2).qualifier(), InertialTypes::CH_Z);
    BOOST_CHECK_EQUAL(data.at(2).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(2).valid(), false);
    BOOST_CHECK_CLOSE(data.at(2).as_float(), 16.001, 0.0001);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_EstimatedAccelScaleFactorUncert_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_ACCEL_SCALE_FACTOR_UNCERT, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_ACCEL_SCALE_FACTOR_UNCERT);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_X);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(0).valid(), false);
    BOOST_CHECK_CLOSE(data.at(0).as_float(), 1.978, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_ACCEL_SCALE_FACTOR_UNCERT);
    BOOST_CHECK_EQUAL(data.at(1).qualifier(), InertialTypes::CH_Y);
    BOOST_CHECK_EQUAL(data.at(1).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(1).valid(), false);
    BOOST_CHECK_CLOSE(data.at(1).as_float(), 4.789, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_ACCEL_SCALE_FACTOR_UNCERT);
    BOOST_CHECK_EQUAL(data.at(2).qualifier(), InertialTypes::CH_Z);
    BOOST_CHECK_EQUAL(data.at(2).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(2).valid(), false);
    BOOST_CHECK_CLOSE(data.at(2).as_float(), 16.001, 0.0001);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_CompensatedAccel_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_COMPENSATED_ACCEL, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_COMPENSATED_ACCEL);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_X);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(0).valid(), false);
    BOOST_CHECK_CLOSE(data.at(0).as_float(), 1.978, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_COMPENSATED_ACCEL);
    BOOST_CHECK_EQUAL(data.at(1).qualifier(), InertialTypes::CH_Y);
    BOOST_CHECK_EQUAL(data.at(1).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(1).valid(), false);
    BOOST_CHECK_CLOSE(data.at(1).as_float(), 4.789, 0.0001);
    ...
    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_COMPENSATED_ACCEL);
    BOOST_CHECK_EQUAL(data.at(2).qualifier(), InertialTypes::CH_Z);
    BOOST_CHECK_EQUAL(data.at(2).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(2).valid(), false);
    BOOST_CHECK_CLOSE(data.at(2).as_float(), 16.001, 0.0001);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_StdAtmModel_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_STD_ATMOSPHERE_MODEL, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_STD_ATMOSPHERE_MODEL);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_GEOMETRIC_ALTITUDE);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(0).valid(), false);
    BOOST_CHECK_CLOSE(data.at(0).as_float(), 1.978, 0.0001);
    BOOST_CHECK_NO_THROW(data.at(0).channelName());

    BOOST_CHECK_EQUAL(data.at(1).field(), InertialTypes::CH_FIELD_ESTFILTER_STD_ATMOSPHERE_MODEL);
    BOOST_CHECK_EQUAL(data.at(1).qualifier(), InertialTypes::CH_GEOPOTENTIAL_ALTITUDE);
    BOOST_CHECK_EQUAL(data.at(1).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(1).valid(), false);
    BOOST_CHECK_CLOSE(data.at(1).as_float(), 4.789, 0.0001);
    BOOST_CHECK_NO_THROW(data.at(1).channelName());

    BOOST_CHECK_EQUAL(data.at(2).field(), InertialTypes::CH_FIELD_ESTFILTER_STD_ATMOSPHERE_MODEL);
    BOOST_CHECK_EQUAL(data.at(2).qualifier(), InertialTypes::CH_TEMPERATURE);
    BOOST_CHECK_EQUAL(data.at(2).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(2).valid(), false);
    BOOST_CHECK_CLOSE(data.at(2).as_float(), 16.001, 0.0001);
    BOOST_CHECK_NO_THROW(data.at(2).channelName());

    BOOST_CHECK_EQUAL(data.at(3).field(), InertialTypes::CH_FIELD_ESTFILTER_STD_ATMOSPHERE_MODEL);
    BOOST_CHECK_EQUAL(data.at(3).qualifier(), InertialTypes::CH_PRESSURE);
    BOOST_CHECK_EQUAL(data.at(3).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(3).valid(), false);
    BOOST_CHECK_CLOSE(data.at(3).as_float(), 16.001, 0.0001);
    BOOST_CHECK_NO_THROW(data.at(3).channelName());

    BOOST_CHECK_EQUAL(data.at(4).field(), InertialTypes::CH_FIELD_ESTFILTER_STD_ATMOSPHERE_MODEL);
    BOOST_CHECK_EQUAL(data.at(4).qualifier(), InertialTypes::CH_DENSITY);
    BOOST_CHECK_EQUAL(data.at(4).storedAs(), valueType_float);
...
BOOST_AUTO_TEST_CASE(InertialFieldParser_PressureAltitude_parse)
{
    ...
    //Create the Data Field
    InertialDataField field(InertialTypes::CH_FIELD_ESTFILTER_PRESSURE_ALTITUDE, bytes.data());
    ...
    BOOST_CHECK_EQUAL(data.at(0).field(), InertialTypes::CH_FIELD_ESTFILTER_PRESSURE_ALTITUDE);
    BOOST_CHECK_EQUAL(data.at(0).qualifier(), InertialTypes::CH_ALTITUDE);
    BOOST_CHECK_EQUAL(data.at(0).storedAs(), valueType_float);
    BOOST_CHECK_EQUAL(data.at(0).valid(), false);
