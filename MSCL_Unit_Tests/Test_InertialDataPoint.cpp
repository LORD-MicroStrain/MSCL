...
BOOST_AUTO_TEST_CASE(InertialDataPoint_Constructor)
{
    ...
    MipDataPoint p(MipTypes::CH_FIELD_SENSOR_RAW_ACCEL_VEC, MipTypes::CH_X, valueType_float, anyType(x), true);

    //make sure the member variables are all set correctly
    BOOST_CHECK_EQUAL(p.field(), MipTypes::CH_FIELD_SENSOR_RAW_ACCEL_VEC);
    BOOST_CHECK_EQUAL(p.qualifier(), MipTypes::CH_X);
    BOOST_CHECK_EQUAL(p.storedAs(), valueType_float);
...
BOOST_AUTO_TEST_CASE(InertialDataPoint_asVector)
{
    ...
    MipDataPoint p(MipTypes::CH_FIELD_SENSOR_ORIENTATION_QUATERNION, MipTypes::CH_QUATERNION, valueType_Vector, anyType(Vector(valueType_uint16, bytes)), true);
...
BOOST_AUTO_TEST_CASE(InertialDataPoint_asMatrix)
{
    ...
    MipDataPoint p(MipTypes::CH_FIELD_SENSOR_ORIENTATION_MATRIX, MipTypes::CH_MATRIX, valueType_Matrix, anyType(Matrix(1, 2, valueType_uint16, bytes)), true);
...
BOOST_AUTO_TEST_CASE(InertialDataPoint_asBytes)
{
    ...
    MipDataPoint p((MipTypes::ChannelField)0, MipTypes::CH_UNKNOWN, valueType_Bytes, anyType(bytes.data()), true);
...
{
    MipDataPoint p((MipTypes::ChannelField)0, MipTypes::CH_TIMESTAMP, valueType_Timestamp, anyType(Timestamp(1363189940788455000)), true);
...
{
    uint8 val = 240;
    MipDataPoint p((MipTypes::ChannelField)0, MipTypes::CH_X, valueType_uint8, anyType(val), true);
...
{
    uint16 val = 25;
    MipDataPoint p((MipTypes::ChannelField)0, MipTypes::CH_X, valueType_uint16, anyType(val), true);
...
BOOST_AUTO_TEST_CASE(InertialDataPoint_asString_uint32)
{
    ...
    MipDataPoint p((MipTypes::ChannelField)0, MipTypes::CH_X, valueType_uint32, anyType(val), true);
...
{
    int16 val = -36;
    MipDataPoint p((MipTypes::ChannelField)0, MipTypes::CH_X, valueType_int16, anyType(val), true);
...
{
    int32 val = 35;
    MipDataPoint p((MipTypes::ChannelField)0, MipTypes::CH_X, valueType_int32, anyType(val), true);
...
{
    MipDataPoint p((MipTypes::ChannelField)0, MipTypes::CH_X, valueType_float, anyType(1.23f), true);
...
{
    MipDataPoint p((MipTypes::ChannelField)0, MipTypes::CH_X, valueType_double, anyType(4.56), true);
...
BOOST_AUTO_TEST_CASE(InertialDataPoint_asString_Vector)
{
    ...
    MipDataPoint p((MipTypes::ChannelField)0, MipTypes::CH_X, valueType_Vector, anyType(Vector(valueType_uint16, bytes)), true);
    ...
    MipDataPoint p2((MipTypes::ChannelField)0, MipTypes::CH_X, valueType_Vector, anyType(Vector(valueType_float, bytes2)), true);
...
BOOST_AUTO_TEST_CASE(InertialDataPoint_asString_Matrix)
{
    ...
    MipDataPoint p((MipTypes::ChannelField)0, MipTypes::CH_X, valueType_Matrix, anyType(Matrix(3, 2, valueType_float, bytes)), true);
    ...
    MipDataPoint p2((MipTypes::ChannelField)0, MipTypes::CH_X, valueType_Matrix, anyType(Matrix(3, 2, valueType_uint16, bytes2)), true);
...
{
    MipDataPoint p((MipTypes::ChannelField)0, MipTypes::CH_X, valueType_Timestamp, anyType(Timestamp(1363189940788455000)), true);
...
BOOST_AUTO_TEST_CASE(InertialDataPoint_asString_Bytes)
{
    ...
    MipDataPoint p((MipTypes::ChannelField)0, MipTypes::CH_X, valueType_Bytes, anyType(bytes.data()), true);
