...
BOOST_AUTO_TEST_CASE(Value_as_float)
{
	...
	BOOST_CHECK_THROW(val_double.as_float(), Error_BadDataType);	//out of range of a float
...
BOOST_AUTO_TEST_CASE(Value_as_uint8)
{
	...
	BOOST_CHECK_THROW(val_double.as_uint8(), Error_BadDataType);	//out of range
	BOOST_CHECK_EQUAL(val_uint16.as_uint8(), 12);
	BOOST_CHECK_THROW(val_uint32.as_uint8(), Error_BadDataType);
	BOOST_CHECK_THROW(val_int16.as_uint8(), Error_BadDataType);
...
BOOST_AUTO_TEST_CASE(Value_as_uint16)
{
	...
	BOOST_CHECK_THROW(val_double.as_uint16(), Error_BadDataType);	//out of range
	BOOST_CHECK_EQUAL(val_uint16.as_uint16(), 65531);
	BOOST_CHECK_THROW(val_uint32.as_uint16(), Error_BadDataType);
	BOOST_CHECK_THROW(val_int16.as_uint16(), Error_BadDataType);
...
BOOST_AUTO_TEST_CASE(Value_as_uint32)
{
	...
	BOOST_CHECK_THROW(val_int16.as_uint32(), Error_BadDataType);
...
BOOST_AUTO_TEST_CASE(Value_as_int16)
{
	...
	BOOST_CHECK_THROW(val_double.as_int16(), Error_BadDataType);
	BOOST_CHECK_THROW(val_uint16.as_int16(), Error_BadDataType);
	BOOST_CHECK_EQUAL(val_uint32.as_int16(), 32000);
	BOOST_CHECK_EQUAL(val_int16.as_int16(), -48);
	BOOST_CHECK_THROW(val_int32.as_int16(), Error_BadDataType);
	BOOST_CHECK_EQUAL(val_uint8.as_int16(), 12);
	BOOST_CHECK_EQUAL(val_bool.as_int16(), 0);
	BOOST_CHECK_THROW(val_string.as_int16(), Error_BadDataType);
}
