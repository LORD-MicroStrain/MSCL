...
%catches(mscl::Error_NotSupported, mscl::Error_NodeCommunication, mscl::Error_InvalidNodeConfig, mscl::Error_Connection, mscl::Error)									mscl::SyncSamplingNetwork::setPendingConfig(uint16 nodeAddress, const WirelessNodeConfig& config);
%catches(mscl::Error_NotSupported, mscl::Error_NodeCommunication, mscl::Error_Connection, mscl::Error)																	mscl::SyncSamplingNetwork::clearPendingConfig(uint16 nodeAddress);
%catches(mscl::Error_NotSupported, mscl::Error_NodeCommunication, mscl::Error_Connection)																				mscl::SyncSamplingNetwork::clearAllPendingConfigs();
