...
%{
	...
	CSharpExceptionCallback_t exceptionCallback__MSCL_Timeout = NULL;
	
	extern "C" SWIGEXPORT
	void SWIGSTDCALL ExceptionRegisterCallback__MSCL_Timeout(CSharpExceptionCallback_t customCallback) 
	{
		exceptionCallback__MSCL_Timeout = customCallback;
	}
	
	static void SWIG_CSharpSetPendingExceptionCustom__MSCL_Timeout(const char *msg) 
	{
		exceptionCallback__MSCL_Timeout(msg);
	}
	//===================================================================================================
...
%{
	...
	//===================================================================================================
	//                                EXCEPTION: Error_Timeout
	class Exception_Helper__MSCL_Timeout 
	{
		// C# delegate for the C/C++ exceptionCallback_MSCL_
		public delegate void exception_Delegate(string message);
		
		static exception_Delegate customDelegate__MSCL_Timeout = new exception_Delegate(SetPendingCustomException__MSCL_Timeout);

		[global::System.Runtime.InteropServices.DllImport("$dllimport", EntryPoint="ExceptionRegisterCallback__MSCL_Timeout")]
		public static extern void ExceptionRegisterCallback__MSCL_Timeout(exception_Delegate customCallback);

		static void SetPendingCustomException__MSCL_Timeout(string message) 
		{
			SWIGPendingException.Set(new mscl.Error_Timeout(message));
		}

		static Exception_Helper__MSCL_Timeout() 
		{
			ExceptionRegisterCallback__MSCL_Timeout(customDelegate__MSCL_Timeout);
		}
	}
	
	static Exception_Helper__MSCL_Timeout exceptionHelper_timeout = new Exception_Helper__MSCL_Timeout();
	//===================================================================================================
...
//Exception: Error_Timeout
%typemap(throws, canthrow=1) mscl::Error_Timeout 
{
	SWIG_CSharpSetPendingExceptionCustom__MSCL_Timeout($1.what());
	return $null;
}
...
%catches(mscl::Error_Connection, mscl::Error_Communication)															mscl::BaseStation::readEeprom(uint16 eepromAddress) const;
%catches(mscl::Error_Connection, mscl::Error_Communication)															mscl::BaseStation::writeEeprom(uint16 eepromAddress, uint16 value);
...
%catches(mscl::Error_Connection, mscl::Error_Communication, mscl::Error)											mscl::BaseStation::changeFrequency(WirelessTypes::Frequency frequency);
...
%catches(mscl::Error_Connection, mscl::Error_Communication)															mscl::BaseStation::frequency() const;
%catches(mscl::Error_Connection, mscl::Error_Communication)															mscl::BaseStation::firmwareVersion() const;
%catches(mscl::Error_Connection, mscl::Error_Communication)															mscl::BaseStation::model() const;
%catches(mscl::Error_Connection, mscl::Error_Communication)															mscl::BaseStation::serial() const;
%catches(mscl::Error_Connection, mscl::Error_Communication)															mscl::BaseStation::name() const;
%catches(mscl::Error_Connection, mscl::Error_Communication)															mscl::BaseStation::microcontroller() const;
%catches(mscl::Error_Connection, mscl::Error_NoData)																mscl::BaseStation::getNextData();
%catches(mscl::Error_Connection, mscl::Error_NoData)																mscl::BaseStation::getNextData(uint32 timeout);
...
%catches(mscl::Error_Connection, mscl::Error_Communication)															mscl::BaseStation::getTransmitPower() const;
...
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::readEeprom(uint16 location) const;
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::writeEeprom(uint16 location, uint16 value);
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::cyclePower();
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::resetRadio();
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::changeFrequency(WirelessTypes::Frequency frequency);
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::frequency() const;
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::firmwareVersion() const;
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::model() const;
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::serial() const;
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::microcontroller() const;
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::radioFeatures() const;
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::dataStorageSize() const;
...
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::getNumDatalogSessions() const;
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::getDefaultMode() const;
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::getInactivityTimeout() const;
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::getCheckRadioInterval() const;
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::getTransmitPower() const;
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::getSamplingMode() const;
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::getActiveChannels() const;
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::getSampleRate() const;
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::getNumSweeps() const;
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::getUnlimitedDuration() const;
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::getDataFormat() const;
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																mscl::WirelessNode::getDataCollectionMethod() const;
...
//InertialNode
%catches(mscl::Error_Timeout, mscl::Error_Connection, mscl::Error)																mscl::InertialNode::InertialNode(Connection connection);
%catches(mscl::Error_InertialCmdFailed, mscl::Error_Timeout, mscl::Error_NotSupported, mscl::Error_Connection, mscl::Error)		mscl::InertialNode::supportedSampleRates(InertialTypes::ChannelField channelId);
%catches(mscl::Error_Connection, mscl::Error_NoData, mscl::Error)																mscl::InertialNode::getNextDataPacket();
%catches(mscl::Error_Connection, mscl::Error_NoData, mscl::Error)																mscl::InertialNode::getNextDataPacket(uint32 timeout);
...
%catches(mscl::Error_InertialCmdFailed, mscl::Error_Timeout, mscl::Error_Connection, mscl::Error)								mscl::InertialNode::info();
%catches(mscl::Error_Connection)																								mscl::InertialNode::ping();
%catches(mscl::Error_InertialCmdFailed, mscl::Error_Timeout, mscl::Error_NotSupported, mscl::Error_Connection)					mscl::InertialNode::getDataRateBase(InertialTypes::InertialCategory category);
%catches(mscl::Error_InertialCmdFailed, mscl::Error_Timeout, mscl::Error_NotSupported, mscl::Error_Connection)					mscl::InertialNode::getActiveChannelFields(InertialTypes::InertialCategory category);
%catches(mscl::Error_InertialCmdFailed, mscl::Error_Timeout, mscl::Error_NotSupported, mscl::Error_Connection, mscl::Error)		mscl::InertialNode::setActiveChannelFields(InertialTypes::InertialCategory category, const InertialChannels& channels);
%catches(mscl::Error_InertialCmdFailed, mscl::Error_Timeout, mscl::Error_NotSupported, mscl::Error_Connection)					mscl::InertialNode::getCommunicationMode();
%catches(mscl::Error_InertialCmdFailed, mscl::Error_Timeout, mscl::Error_Connection)											mscl::InertialNode::setCommunicationMode(uint8 communicationMode);
%catches(mscl::Error_InertialCmdFailed, mscl::Error_Timeout, mscl::Error_NotSupported, mscl::Error_Connection)					mscl::InertialNode::enableDataStream(InertialTypes::InertialCategory category);
...
//SyncSamplingNetwork
%catches(mscl::Error_NodeCommunication, mscl::Error_InvalidNodeConfig, mscl::Error_Connection, mscl::Error_UnknownSampleRate, mscl::Error)			mscl::SyncSamplingNetwork::addNode(WirelessNode& node);
%catches(mscl::Error_NodeCommunication, mscl::Error_InvalidNodeConfig, mscl::Error_Connection, mscl::Error_UnknownSampleRate, mscl::Error)			mscl::SyncSamplingNetwork::addNode(WirelessNode& node, const WirelessNodeConfig& pendingConfig);
...
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection, mscl::Error_UnknownSampleRate)														mscl::SyncSamplingNetwork::lossless(bool enable);
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection, mscl::Error_UnknownSampleRate)														mscl::SyncSamplingNetwork::highCapacity(bool enable);
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection, mscl::Error)																		mscl::SyncSamplingNetwork::applyConfiguration();
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection, mscl::Error)																		mscl::SyncSamplingNetwork::startSampling();
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection, mscl::Error)																		mscl::SyncSamplingNetwork::startSampling(Timestamp startTime);
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection, mscl::Error)																		mscl::SyncSamplingNetwork::startSampling_noBeacon();
%catches(mscl::Error)																																mscl::SyncSamplingNetwork::getNodeNetworkInfo(uint16 nodeAddress);
%catches(mscl::Error_NodeCommunication, mscl::Error_InvalidNodeConfig, mscl::Error_Connection, mscl::Error)											mscl::SyncSamplingNetwork::setPendingConfig(uint16 nodeAddress, const WirelessNodeConfig& config);
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection, mscl::Error)																		mscl::SyncSamplingNetwork::clearPendingConfig(uint16 nodeAddress);
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)																						mscl::SyncSamplingNetwork::clearAllPendingConfigs();
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection, mscl::Error_UnknownSampleRate)														mscl::SyncSamplingNetwork::refresh();

//ArmedDataloggingNetwork
%catches(mscl::Error_NodeCommunication, mscl::Error_InvalidNodeConfig, mscl::Error_Connection, mscl::Error)											mscl::ArmedDataloggingNetwork::addNode(const WirelessNode& node, const std::string& message);
%catches(mscl::Error_NodeCommunication, mscl::Error_InvalidNodeConfig, mscl::Error_Connection, mscl::Error)											mscl::ArmedDataloggingNetwork::addNode(const WirelessNode& node);
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection, mscl::Error)																		mscl::ArmedDataloggingNetwork::startSampling();

//DatalogDownloader
%catches(mscl::Error_NodeCommunication, mscl::Error_Connection)								mscl::DatalogDownloader::DatalogDownloader(const WirelessNode& node);
%catches(mscl::Error_NodeCommunication, mscl::Error_NoData, mscl::Error_Connection)			mscl::DatalogDownloader::getNextData();
