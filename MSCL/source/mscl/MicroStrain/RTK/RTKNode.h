...
namespace mscl
{
    ...
    public:
        ...
        explicit RTKNode(Connection connection);

        virtual ~RTKNode() {}

#ifndef SWIG
        RTKNode(std::shared_ptr<MipNode_Impl> impl); //constructor with direct underlying implementation for this class.
#endif

    private:
        //Variable: m_impl
        //    The <MipNode_Impl> class that contains all the implementation logic for the RTKNode class.
    ...
    public:   
        ...
        //
        //Parameters:
        //    serial - The serial number of the node. This should be identical to calling the <serialNumber> function on an <MipNodeInfo> object (see <RTKNode::info>).
        //
        //Returns:
        ...
        //    Gets the <Connection> object that this RTKNode is using.
        //
        //Returns:
        //    The <Connection> object that this RTKNode is using.
        Connection& connection();

        //API Function: features
        //    Gets a reference to the <MipNodeFeatures> for this device.
        //    Note: This will be invalid when the RTKNode is destroyed.
        //
        //Exceptions:
        ...
        //    Gets the <Timestamp> for the last time MSCL communicated with the RTKNode.
        //
        //Returns:
        ...
        //    Gets the firmware <Version> of the RTKNode.
        //
        //Returns:
        //    The firmware <Version> of the RTKNode.
        //
        //Exceptions:
        //    - <Error_Communication>: There was no response to the command. The command timed out.
        //    - <Error_MipCmdFailed>: The command has failed. Check the error code for more details.
        ...
        //API Function: model
        //    Gets the <RTKModels::NodeModel> of the RTKNode.
        //
        //Returns:
        //    The <RTKModels::NodeModel> of the RTKNode.
        //
        //Exceptions:
        //    - <Error_Communication>: There was no response to the command. The command timed out.
        //    - <Error_MipCmdFailed>: The command has failed. Check the error code for more details.
        //    - <Error_Connection>: Information failed to be loaded for this Node.
        RTKModels::NodeModel model() const;

        //API Function: modelName
        //    Gets the model name of the RTKNode (ie. "3DM-GX3-45").
        //
        //Returns:
        //    The model name of the RTKNode.
        //
        //Exceptions:
        //    - <Error_Communication>: There was no response to the command. The command timed out.
        //    - <Error_MipCmdFailed>: The command has failed. Check the error code for more details.
        ...
        //    Gets the model number of the RTKNode (ie. "6225-4220").
        //
        //Returns:
        //    The model number of the RTKNode.
        //
        //Exceptions:
        //    - <Error_Communication>: There was no response to the command. The command timed out.
        //    - <Error_MipCmdFailed>: The command has failed. Check the error code for more details.
        ...
        //    Gets the serial number of the RTKNode (ie. "6225-01319").
        //
        //Returns:
        //    The serial number of the RTKNode.
        //
        //Exceptions:
        //    - <Error_Communication>: There was no response to the command. The command timed out.
        //    - <Error_MipCmdFailed>: The command has failed. Check the error code for more details.
        ...
        //    Gets the lot number of the RTKNode (ie. "I042Y").
        //
        //Returns:
        //    The lot number of the RTKNode.
        //
        //Exceptions:
        //    - <Error_Communication>: There was no response to the command. The command timed out.
        //    - <Error_MipCmdFailed>: The command has failed. Check the error code for more details.
        ...
        //    Gets the device options of the RTKNode (ie. "5g, 300d/s").
        //
        //Returns:
        //    The device options of the RTKNode.
        //
        //Exceptions:
        //    - <Error_Communication>: There was no response to the command. The command timed out.
        //    - <Error_MipCmdFailed>: The command has failed. Check the error code for more details.
        ...
        //API Function: name
        //    Gets the name of the RTKNode. This is the universal sensor name that should be used for uploading to SensorCloud.
        //    This is the same as calling <RTKNode::deviceName>.
        //
        //Returns:
        //    The universal sensor name.
        std::string name();
