...
namespace mscl
{
    ...
    class MagnetometerHardIronOffset : public InertialCommand
    {
    public:
    ...
    private:
        ...
        MagnetometerHardIronOffset(InertialTypes::FunctionSelector function_selector, GeometricVector dataToUse);
		MagnetometerHardIronOffset(InertialTypes::FunctionSelector function_selector);

        //Function: commandType
		//
        //Returns:
        //    InertialTypes::Command - the command ID.
        virtual InertialTypes::Command commandType() const { return InertialTypes::CMD_MAG_HARD_IRON_OFFSET; }
