...
public:
    ...
    //API Typedefs:
    //  ChannelFields   - A vector of <ChannelField> enums.
    //  Commands        - A vectof of <Command> enums.
    typedef std::vector<ChannelField> InertialChannelFields;
    typedef std::vector<Command> InertialCommands;
