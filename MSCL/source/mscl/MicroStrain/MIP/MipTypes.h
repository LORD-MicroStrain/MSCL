...
namespace mscl
{
    ...
    public:
        ...
        //    CH_BIT_SYSTEM_GENERAL         - 118 - Built In Test System General
        //    CH_BIT_SYSTEM_PROCESS         - 119 - Built In Test System Process
        //    CH_BIT_IMU_GENERAL            - 120 - Built In Test IMU General
        //    CH_BIT_IMU_SENSORS            - 121 - Built In Test IMU Sensors
        //    CH_BIT_IMU_FACTORY_BITS       - 122 - Built in Test IMU Factory Bits Valid
        //    CH_BIT_FILTER_GENERAL         - 123 - Built In Test Est Filter General
        //====================================================================================================
        enum ChannelQualifier
        {
            ...
            CH_BIT_SYSTEM_GENERAL           = 118,
            CH_BIT_SYSTEM_PROCESS           = 119,
            CH_BIT_IMU_GENERAL              = 120,
            CH_BIT_IMU_SENSORS              = 121,
            CH_BIT_IMU_FACTORY_BITS         = 122,
            CH_BIT_FILTER_GENERAL           = 123
        };
