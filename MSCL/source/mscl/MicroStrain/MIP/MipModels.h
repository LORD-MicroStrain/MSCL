...
namespace mscl
{
    ...
    public:
        ...
        //  node_3dm_cv7_gnss_ins - 6292 - 3DM-CV7-GNSS/INS
        //=========================================================================
        enum NodeModel
        {
            node_3dm_dh3          = 6219, // 3DM-DH3
        ...
        //  model_3dm_cv7_gnss_ins - 62929999 - 3DM-CV7-GNSS/INS
        //=========================================================================
        enum ModelNumber
        {
            model_3dm_dh3          = 62199999, // 3DM-DH3
    ...
    public:
        ...
        //  mip_model_3dm_cv7_gnss_ins - 62929999 - 3DM-CV7-GNSS/INS
        //=========================================================================
        ...
        static const MipModel mip_model_3dm_gv7_ins;      // 3DM-GV7-INS
        static const MipModel mip_model_3dm_cv7_ins;      // 3DM-CV7-INS
        static const MipModel mip_model_3dm_cv7_gnss_ins; // 3DM-CV7-GNSS/INS
