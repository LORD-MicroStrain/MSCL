...
namespace mscl
{
    ...
    const EepromLocation NodeEepromMap::LEGACY_BOOTLOAD_PAGE            (230, valueType_uint16);
    const EepromLocation NodeEepromMap::LEGACY_BOOTLOAD_ENABLE_FLAG     (232, valueType_uint16);
    const EepromLocation NodeEepromMap::LEGACY_BOOTLOAD_CHECKSUM        (234, valueType_uint16);
    const EepromLocation NodeEepromMap::LEGACY_BOOTLOADER_VER           (236, valueType_uint16);
    const EepromLocation NodeEepromMap::LEGACY_BOOTLOADER_OPTIONS       (238, valueType_uint16);
    const EepromLocation NodeEepromMap::LEGACY_BOOTLOADER_COUNTER       (240, valueType_uint16);
    ...
    const EepromLocation NodeEepromMap::ANTI_ALIASING_FILTER_1          (440, valueType_uint16);
    ...
    void NodeEepromMap::getEventTriggerEeproms(uint8 triggerIndex, bool isFloatVal, EepromLocation& channel, EepromLocation& type, EepromLocation& value)
    {
        ...
        EepromLocation valueEeprom(EVENT_VAL1_1.id() + idDiff, EVENT_VAL1_1.location() + eepromDiff, eventValType);
