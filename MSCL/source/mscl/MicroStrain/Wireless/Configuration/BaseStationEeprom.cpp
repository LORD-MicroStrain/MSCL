...
namespace mscl
{
	BaseStationEeprom::BaseStationEeprom(BaseStation_Impl* base, bool useCache) : //useCache=true
		Eeprom(useCache),
		m_baseStation(base)
	{ }

	bool BaseStationEeprom::updateCacheFromDevice(uint16 location, bool canUseGroupDownload)
	{
		uint16 eepromVal;
