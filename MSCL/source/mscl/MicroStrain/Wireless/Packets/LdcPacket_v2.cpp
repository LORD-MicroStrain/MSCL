...
namespace mscl
{
    LdcPacket_v2::LdcPacket_v2(const WirelessPacket& packet)
    {
    ...
    UniqueWirelessPacketId LdcPacket_v2::getUniqueId(const WirelessPacket& packet)
    {
